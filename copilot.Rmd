...
Unlike thin-wrapper tools that merely concatenate strings to prompt an LLM, `sclet_copilot` genuinely reads and comprehends the complete operational bloodline of your `SingleCellExperiment` object.
