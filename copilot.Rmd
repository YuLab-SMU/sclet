...
```{r copilot-setup, include=FALSE}
# NOTE: Chunks use eval=FALSE because sclet_copilot/AuditAnalysisChain require:
# - aisdk package + configured AI API credentials
# - Not suitable for CI/CD environments without API keys
```
