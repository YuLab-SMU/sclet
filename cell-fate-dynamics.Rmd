...
# NOTE: Velocity, CellRank, and fate chunks use eval=FALSE because they need:
# - scVelo/CellRank via Python basilisk (~2GB env)
# - spliced/unspliced assays not present in the PBMC demo data
# RunDiffusionMap, RunSlingshot, and diffusion-map chunks run in CI.
```
...
```{r velocity-latent, eval=FALSE}    # requires scVelo dynamical mode latent time
