...
This mainline answers a simple downstream question: once cells have been grouped, annotated, or placed along a trajectory, which pathways, programs, and transcription factors actually explain the state difference? In `sclet`, this is where signature scoring, pathway-level summarization, and regulon inference start to connect into one interpretation chain.
