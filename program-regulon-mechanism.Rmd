...
# NOTE: RunKEGG/RunSCENIC/RunGRN chunks use eval=FALSE because they need:
# - pySCENIC (Python basilisk) + TFs/motif/database files
# - KEGG database download via clusterProfiler
# RunGeneSetScoring and general plot_* chunks run in CI with the PBMC object.
```
