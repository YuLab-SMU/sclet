# Cell-Cell Communication and Microenvironment Interaction {#communication}
...
```{r cci-setup, include=FALSE}
# NOTE: CellChat chunks now run in CI (CellChat already in bookdown.yaml deps).
# CellPhoneDB and NicheNet chunks use eval=FALSE because:
# - CellPhoneDB needs Python basilisk environment
# - NicheNet needs pre-downloaded prior model databases
```
...
```{r cci-sigmoid, fig.width=8, fig.height=6, eval=eval_chunks && requireNamespace("ggbump", quietly = TRUE)}
