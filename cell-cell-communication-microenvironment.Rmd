...
# NOTE: RunCCI backend chunks use eval=FALSE because:
# - CellChat, CellPhoneDB (Python basilisk), NicheNet each require their own packages
# - Python-based backends need basilisk environments
# The general RunCCI dispatcher and state contract code runs in CI.
```
