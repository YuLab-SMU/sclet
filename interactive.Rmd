...
```{r interactive-setup, include=FALSE}
# NOTE: Chunks use eval=FALSE because iSEE-based RunExplorer launches a Shiny app.
# The function is interactive by nature and cannot run in a headless CI environment.
```
