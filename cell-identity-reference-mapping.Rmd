...
```{r run-knn-predict-cache, include=FALSE, eval=FALSE}
knn_query_sce <- if (file.exists("data/knn-refmap-pbmc.rds")) {
    readRDS("data/knn-refmap-pbmc.rds")
} else {
    NULL
}
```
...
### State-aware SingleR provenance
...
### Comparison with manual annotation result
