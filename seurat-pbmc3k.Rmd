...
The difference is that everything happens on top of `SingleCellExperiment`, with the `sclet` wrappers providing a familiar Seurat-like user experience. The goal here is not only to reproduce a standard workflow, but also to show how little boilerplate is needed once the state-aware design is in place.
